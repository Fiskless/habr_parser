...
def create_argument_parser():
    ...
    parser.add_argument(
        ...
        nargs='?',
        default='https://drive.google.com/file/d/1oIAXcPzyxpTEj5hdZ8bZPA4TPVX9k_nC/view',
        type=str
    )
    parser.add_argument(
        '--dest_folder',
...
def read_csv_from_google_drive(url='https://drive.google.com/file/d/1oIAXcPzyxpTEj5hdZ8bZPA4TPVX9k_nC/view'):
...
def main():
    ...
    # for user_link in read_csv_from_google_drive():
